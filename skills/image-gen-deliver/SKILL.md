...
**示例 (Telegram)**:
```bash
python3 /root/.openclaw/workspace/image_sender.py /root/nanobanana_outputs/nanobanana_20260406_030939.jpg telegram <telegram_user_id>
```

**示例 (Feishu)**:
```bash
python3 /root/.openclaw/workspace/image_sender.py /root/nanobanana_outputs/nanobanana_20260406_030939.jpg feishu <feishu_open_id>
```
